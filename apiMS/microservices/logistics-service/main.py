"""
Aplicación principal del microservicio de logística
"""
...
from .application.services import LogisticsEventHandler, setup_event_handlers
...
async def lifespan(app: FastAPI):
    ...
    event_handler = LogisticsEventHandler()
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Microservicio de logística con arquitectura hexagonal",
        version="1.0.0",
