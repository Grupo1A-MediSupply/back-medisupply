"""
Repositorios de infraestructura - Versión corregida para monolito
"""
import sys
...
shared_path = str(monolith_path / "shared")
if shared_path not in sys.path:
    sys.path.insert(0, shared_path)

# Agregar el directorio del auth-service al PYTHONPATH
auth_service_path = str(monolith_path / "auth")
...
# Base ya importada desde infrastructure.database
