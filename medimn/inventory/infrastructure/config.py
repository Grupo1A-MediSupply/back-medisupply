"""
Configuración del servicio de inventory (adaptado para monolito)
"""
import sys
...
class InventoryServiceSettings:
    """Configuración del servicio de inventory (wrapper sobre configuración del monolito)"""
