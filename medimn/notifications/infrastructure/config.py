"""
Configuración del servicio de notifications (adaptado para monolito)
"""
import sys
...
class NotificationsServiceSettings:
    """Configuración del servicio de notifications (wrapper sobre configuración del monolito)"""
