"""
Configuración del servicio de reports (adaptado para monolito)
"""
import sys
...
class ReportsServiceSettings:
    """Configuración del servicio de reports (wrapper sobre configuración del monolito)"""
